...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/fien/bpe2bpe_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en1.180000.npz'
    model2 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en2.200000.npz'
    model3 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en3.120000.npz'
    model4 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en4.185000.npz'
    model5 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en5.210000.npz'
    model6 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en6.205000.npz'
    model7 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en7.205000.npz'
    model8 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam.165000.npz'
    models = [model1, model2, model3, model4, model5, model6, model7, model8]
    dictionary = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/fien/train/all_fi-en.en.tok.bpe.word.pkl'
    dictionary_target = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/fien/train/all_fi-en.fi.tok.bpe.word.pkl'
