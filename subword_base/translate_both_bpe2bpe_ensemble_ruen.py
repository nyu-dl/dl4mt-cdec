...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/ruen/bpe2bpe_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en1.240000.npz'
    model2 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en2.195000.npz'
    model3 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en3.220000.npz'
    model4 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en4.205000.npz'
    model5 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en5.205000.npz'
    model6 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en6.205000.npz'
    model7 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en7.170000.npz'
    model8 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam.205000.npz'
    models = [model1, model2, model3, model4, model5, model6, model7, model8]
    dictionary = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/train/all_ru-en.en.tok.bpe.word.pkl'
    dictionary_target = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/train/all_ru-en.ru.tok.bpe.word.pkl'
    source = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/dev/newstest2013-src.en.tok.bpe'
    #source = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/test/newstest2014-ruen-src.en.tok.bpe'
    #source = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/test/newstest2015-ruen-src.en.tok.bpe'
