...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/deen/bpe2bpe_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en1.290000.npz'
    model2 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en2.260000.npz'
    model3 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en3.290000.npz'
    model4 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam.335000.npz'
    models = [model1, model2, model3, model4]
    dictionary = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/deen/train/all_de-en.en.tok.bpe.word.pkl'
    dictionary_target = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/deen/train/all_de-en.de.tok.bpe.word.pkl'
