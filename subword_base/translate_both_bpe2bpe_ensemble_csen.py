...
def gen_sample(tparams, f_inits, f_nexts, x, options, trng=None,
    ...
    for ii in xrange(maxlen):
        ...
        for i in xrange(num_models):
            ...
            inps = [next_w, ctx, next_state_chars[i], next_state_words[i]]
            ret = f_nexts[i](*inps)
            next_p, _, next_state_char, next_state_word = ret[0], ret[1], ret[2], ret[3]
...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/csen/bpe2bpe_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en1.315000.npz'
    model2 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en2.335000.npz'
    model3 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en3.310000.npz'
    model4 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en4.320000.npz'
    model5 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en5.345000.npz'
    model6 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en6.330000.npz'
    model7 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam_en7.325000.npz'
    model8 = model_path + 'bpe2bpe_two_layer_gru_decoder_both_adam.410000.npz'
    models = [model1, model2, model3, model4, model5, model6, model7, model8]
    dictionary = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/train/all_cs-en.en.tok.bpe.word.pkl'
    dictionary_target = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/train/all_cs-en.cs.tok.bpe.word.pkl'
    source = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/dev/newstest2013-src.en.tok.bpe'
    #source = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/test/newstest2014-csen-src.en.tok.bpe'
    #source = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/test/newstest2015-csen-src.en.tok.bpe'
