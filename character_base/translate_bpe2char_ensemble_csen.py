...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/csen/bpe2char_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en1.570000.npz'
    model2 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en2.570000.npz'
    model3 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en3.575000.npz'
    model4 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en4.555000.npz'
    model5 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en5.565000.npz'
    model6 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en6.560000.npz'
    model7 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en7.585000.npz'
    model8 = model_path + 'bpe2char_two_layer_gru_decoder_adam.635000.npz'
    models = [model1, model2, model3, model4, model5, model6, model7, model8]
    dictionary = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/train/all_cs-en.en.tok.bpe.word.pkl'
    dictionary_target = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/csen/train/all_cs-en.cs.tok.300.pkl'
