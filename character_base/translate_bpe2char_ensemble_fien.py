...
if __name__ == "__main__":
    ...
    model_path = '/scratch/jc7382/acl2016/wmt15/fien/bpe2char_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en1.205000.npz'
    model2 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en2.200000.npz'
    model3 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en3.200000.npz'
    model4 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en4.200000.npz'
    model5 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en5.210000.npz'
    model6 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en6.205000.npz'
    model7 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en7.200000.npz'
    model8 = model_path + 'new_bpe2char_two_layer_gru_decoder_adam.240000.npz'
    models = [model1, model2, model3, model4, model5, model6, model7, model8]
    dictionary = '/scratch/jc7382/data/wmt15/fien/train/all_fi-en.en.tok.bpe.word.pkl'
    dictionary_target = '/scratch/jc7382/data/wmt15/fien/train/all_fi-en.fi.tok.300.pkl'
    source = '/scratch/jc7382/data/wmt15/fien/dev/newsdev2015-enfi-src.en.tok.bpe'
    #source = '/scratch/jc7382/data/wmt15/fien/test/newstest2015-fien-src.en.tok.bpe'
