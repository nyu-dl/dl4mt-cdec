...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/ruen/bpe2char_two_layer_gru_decoder/0209/'
    model1 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en1.360000.npz'
    model2 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en2.355000.npz'
    model3 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en3.380000.npz'
    model4 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en4.340000.npz'
    model5 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en5.255000.npz'
    model6 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en6.250000.npz'
    model7 = model_path + 'bpe2char_two_layer_gru_decoder_adam_en7.330000.npz'
    model8 = model_path + 'bpe2char_two_layer_gru_decoder_adam.415000.npz'
    models = [model1, model2, model3, model4, model5, model6, model7, model8]
    dictionary = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/train/all_ru-en.en.tok.bpe.word.pkl'
    dictionary_target = '/misc/kcgscratch1/ChoGroup/junyoung_exp/wmt15/ruen/train/all_ru-en.ru.tok.300.pkl'
