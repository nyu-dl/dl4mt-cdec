...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/csen/bpe2char_seg_gru_decoder/0209/'
    model1 = model_path + 'bpe2char_seg_gru_decoder_adam_en1.630000.npz'
    model2 = model_path + 'bpe2char_seg_gru_decoder_adam.670000.npz'
    model3 = model_path + 'bpe2char_seg_gru_decoder_adam_en3.630000.npz'
    model4 = model_path + 'bpe2char_seg_gru_decoder_adam_en4.715000.npz'
    model5 = model_path + 'bpe2char_seg_gru_decoder_adam_en5.650000.npz'
    model6 = model_path + 'bpe2char_seg_gru_decoder_adam_en6.645000.npz'
    model7 = model_path + 'bpe2char_seg_gru_decoder_adam_en7.650000.npz'
    model8 = model_path + 'bpe2char_seg_gru_decoder_adam_en8.630000.npz'
