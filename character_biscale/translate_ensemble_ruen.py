...
if __name__ == "__main__":
    ...
    model_path = '/misc/kcgscratch1/ChoGroup/junyoung_exp/acl2016/wmt15/ruen/bpe2char_seg_gru_decoder/0209/'
    model1 = model_path + 'bpe2char_seg_gru_decoder_adam_en1.300000.npz'
    model2 = model_path + 'bpe2char_seg_gru_decoder_adam_en2.365000.npz'
    model3 = model_path + 'bpe2char_seg_gru_decoder_adam_en3.360000.npz'
    model4 = model_path + 'bpe2char_seg_gru_decoder_adam_en4.355000.npz'
    model5 = model_path + 'bpe2char_seg_gru_decoder_adam_en5.325000.npz'
    model6 = model_path + 'bpe2char_seg_gru_decoder_adam_en6.335000.npz'
    model7 = model_path + 'bpe2char_seg_gru_decoder_adam_en7.320000.npz'
    model8 = model_path + 'bpe2char_seg_gru_decoder_adam.465000.npz'
