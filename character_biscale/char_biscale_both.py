...
def init_params(options):
    ...
    # decoder
    params = get_layer('seg_gru_decoder_both')[0](options, params,
                                                  prefix='decoder',
...
def build_model(tparams, options):
    ...
    char_h, word_h, bound_c, bound_w, ctxs, alphas = \
            get_layer('seg_gru_decoder_both')[1](tparams, yemb, options,
                                                 prefix='decoder',
                                                 mask=y_mask,
                                                 context=ctx,
                                                 context_mask=x_mask,
...
def build_sampler(tparams, options, trng, use_noise):
    ...
    inps = [y, ctx, init_state_char, init_state_word, init_bound_char, init_bound_word]
    outs = [next_probs, next_sample, next_state_char, next_state_word, next_bound_char, next_bound_word]
